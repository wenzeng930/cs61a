...
CREATE TABLE sentences AS
  ...
  WHERE p1.parent = p2.parent AND p1.child = s1.name AND p2.child = s2.name AND s1.name < s2.name AND s1.size = s2.size;
...
CREATE TABLE stacks AS
  ...
  AND a.height < b.height AND b.height < c.height AND c.height < d.height ORDER BY total_height;
